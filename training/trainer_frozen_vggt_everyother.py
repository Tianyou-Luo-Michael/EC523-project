...
from vggt.models.frozen_vggt_aggregator_everyother import FrozenVGGT_Aggregator_everyother
from trainer_frozen_vggt import FrozenVGGTTrainer
from train_utils.general import safe_makedirs, model_summary


class FrozenVGGTTrainer_everyother(FrozenVGGTTrainer):


    def _setup_components(self):
        logging.info("FrozenVGGTTrainer_everyother: setting up components")
        self.epoch = 0
        ...
        self.model = FrozenVGGT_Aggregator_everyother(
