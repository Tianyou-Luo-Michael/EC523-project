...
from vggt.models.frozen_vggt_aggregator_dpt import FrozenVGGT_Aggregator_DPT
from trainer_frozen_vggt import FrozenVGGTTrainer
from train_utils.general import safe_makedirs, model_summary


class FrozenVGGTTrainer_DPT(FrozenVGGTTrainer):


    def _setup_components(self):
        logging.info("FrozenVGGTTrainer_DPT: setting up components")
        self.epoch = 0
        ...
        self.model = FrozenVGGT_Aggregator_DPT(
