...
from vggt.models.frozen_vggt_aggregator_12 import FrozenVGGT_Aggregator_12
from trainer_frozen_vggt import FrozenVGGTTrainer
from train_utils.general import safe_makedirs, model_summary


class FrozenVGGTTrainer_Aggregator_12(FrozenVGGTTrainer):


    def _setup_components(self):
        logging.info("FrozenVGGTTrainer_Aggregator_12: setting up components")
        self.epoch = 0
        ...
        self.model = FrozenVGGT_Aggregator_12(
