...
class FrozenVGGT_Aggregator_3(VGGT):
    """
    VGGT with all parameters frozen + a trainable CrossAttentionAdapter.

    Injects cross-attention adapter at three positions in aggregated_tokens_list:
    indices [0, 12, 23] — earliest, mid, and near-final pyramid levels.
